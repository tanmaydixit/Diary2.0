...
import go.bits.diary.db.TaskContract;
...
public class Todo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*Intent myIntent = new Intent(this, Todo.class);
        ...
        alarmManager.setRepeating(AlarmManager.RTC_WAKEUP, calendar.getTimeInMillis(), 24 *100, pendingIntent);  //set repeating every 24 hours
        */
        updateUI();//wierd
        cursor.close();
        db.close();
